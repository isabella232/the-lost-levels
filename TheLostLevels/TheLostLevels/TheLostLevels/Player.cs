...
namespace TheLostLevels
{
    ...
    public class Player : DrawableGameComponent
    {
        ...
        public void Draw(GameTime gameTime, GraphicsDeviceManager graphics,Camera gameCamera)
        {
        ...
        protected override void LoadContent()
        {
            ...
            Point center = PlayerInitialRectangle.Center;
            Guy = new CustomModel(CurrentLevel
                  , new Vector3(center.X,0,center.Y)
                , TheLostLevelsGame.Content.Load<Model>("guy"), prop);
